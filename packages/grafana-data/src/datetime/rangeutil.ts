...
const rangeOptions = [
  { from: 'now/d', to: 'now/d', display: t`Today`, section: 2 },
  { from: 'now/d', to: 'now', display: t`Today so far`, section: 2 },
  { from: 'now/w', to: 'now/w', display: t`This week`, section: 2 },
  { from: 'now/w', to: 'now', display: t`This week so far`, section: 2 },
  { from: 'now/M', to: 'now/M', display: t`This month`, section: 2 },
  { from: 'now/M', to: 'now', display: t`This month so far`, section: 2 },
  { from: 'now/y', to: 'now/y', display: t`This year`, section: 2 },
  { from: 'now/y', to: 'now', display: t`This year so far`, section: 2 },

  { from: 'now-1d/d', to: 'now-1d/d', display: t`Yesterday`, section: 1 },
  {
    from: 'now-2d/d',
    to: 'now-2d/d',
    display: t`Day before yesterday`,
    section: 1,
  },
  {
    from: 'now-7d/d',
    to: 'now-7d/d',
    display: t`This day last week`,
    section: 1,
  },
  { from: 'now-1w/w', to: 'now-1w/w', display: t`Previous week`, section: 1 },
  { from: 'now-1M/M', to: 'now-1M/M', display: t`Previous month`, section: 1 },
  { from: 'now-1y/y', to: 'now-1y/y', display: t`Previous year`, section: 1 },
  ...
  { from: 'now-2d', to: 'now', display: t`Last 2 days`, section: 0 },
  { from: 'now-7d', to: 'now', display: t`Last 7 days`, section: 0 },
  { from: 'now-30d', to: 'now', display: t`Last 30 days`, section: 0 },
  { from: 'now-90d', to: 'now', display: t`Last 90 days`, section: 0 },
  { from: 'now-6M', to: 'now', display: t`Last 6 months`, section: 0 },
  { from: 'now-1y', to: 'now', display: t`Last 1 year`, section: 0 },
  { from: 'now-2y', to: 'now', display: t`Last 2 years`, section: 0 },
  { from: 'now-5y', to: 'now', display: t`Last 5 years`, section: 0 },
];

const hiddenRangeOptions = [
  { from: 'now', to: 'now+1m', display: t`Next minute`, section: 3 },
  { from: 'now', to: 'now+5m', display: t`Next 5 minutes`, section: 3 },
  { from: 'now', to: 'now+15m', display: t`Next 15 minutes`, section: 3 },
  { from: 'now', to: 'now+30m', display: t`Next 30 minutes`, section: 3 },
  { from: 'now', to: 'now+1h', display: t`Next hour`, section: 3 },
  { from: 'now', to: 'now+3h', display: t`Next 3 hours`, section: 3 },
  { from: 'now', to: 'now+6h', display: t`Next 6 hours`, section: 3 },
  { from: 'now', to: 'now+12h', display: t`Next 12 hours`, section: 3 },
  { from: 'now', to: 'now+24h', display: t`Next 24 hours`, section: 3 },
  { from: 'now', to: 'now+2d', display: t`Next 2 days`, section: 0 },
  { from: 'now', to: 'now+7d', display: t`Next 7 days`, section: 0 },
  { from: 'now', to: 'now+30d', display: t`Next 30 days`, section: 0 },
  { from: 'now', to: 'now+90d', display: t`Next 90 days`, section: 0 },
  { from: 'now', to: 'now+6M', display: t`Next 6 months`, section: 0 },
  { from: 'now', to: 'now+1y', display: t`Next year`, section: 0 },
  { from: 'now', to: 'now+2y', display: t`Next 2 years`, section: 0 },
  { from: 'now', to: 'now+5y', display: t`Next 5 years`, section: 0 },
];
